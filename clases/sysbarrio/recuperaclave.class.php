...
$_tiempo); 
        ...
        $dbConn->insert("systarjetas.recuperaclave", $_obj);
    ...
    function get_recuperaclave( $idrecuperaclave ) {
        ...
        $_resultSet = $dbConn->doQuery("SELECT * FROM systarjetas.recuperaclave WHERE idrecuperaclave = '$idrecuperaclave'");
    ...
    function update_recuperaclave( $idrecuperaclave, $itemsToBeUpdated = array() ) {
         ...
         $dbConn->update("systarjetas.recuperaclave", "idrecuperaclave = '$idrecuperaclave'");
    }
    ...
    function delete_recuperaclave( $idrecuperaclave ) {
         ...
         $dbConn->delete("systarjetas.recuperaclave", "idrecuperaclave = '$idrecuperaclave'");
    }
    ...
    function list_recuperaclave( $conditionalStatement = '' ) {
         ...
         if(!empty($conditionalStatement)) { 
              $sqlStatement = "SELECT * FROM systarjetas.recuperaclave WHERE $conditionalStatement"; 
         } else { 
              $sqlStatement = "SELECT * FROM systarjetas.recuperaclave";
         }
