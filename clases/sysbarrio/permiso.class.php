...
$__modificoFecha); 
        ...
        $dbConn->insert("systarjetas.permiso", $_obj);
    ...
    function get_permiso( $idPermiso ) {
        ...
        $_resultSet = $dbConn->doQuery("SELECT * FROM systarjetas.permiso WHERE idPermiso = '$idPermiso'");
    ...
    function update_permiso( $idPermiso, $itemsToBeUpdated = array() ) {
         ...
         $dbConn->update("systarjetas.permiso", "idPermiso = '$idPermiso'");
    }
    ...
    function delete_permiso( $idPermiso ) {
         ...
         $dbConn->delete("systarjetas.permiso", "idPermiso = '$idPermiso'");
    }
    ...
    function list_permiso( $conditionalStatement = '' ) {
         ...
         if(!empty($conditionalStatement)) { 
              $sqlStatement = "SELECT * FROM systarjetas.permiso WHERE $conditionalStatement"; 
         } else { 
              $sqlStatement = "SELECT * FROM systarjetas.permiso";
         }
