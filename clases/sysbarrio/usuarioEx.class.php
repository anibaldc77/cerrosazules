...
//--------------- CRUD METHODS ----------------------------- //
   ...
   function get_usuarioEx( $usuario,$clave ) {
	...
	//	print_r("SELECT u.idUsuario,u.nomusuario,u.clave,u.vigente,u.__modificoUsuario,u.__modificoFecha,u.clave1 FROM systarjetas.usuario u WHERE u.nomusuario = '$usuario' AND u.clave = '$clave'"); 
	  // die();		
		$_resultSet = $dbConn->doQuery("SELECT u.idUsuario,u.nomusuario,u.clave,u.vigente,u.__modificoUsuario,u.__modificoFecha,u.clave1 FROM cerrosazules.usuario u WHERE u.nomusuario = '$usuario' AND u.clave = '$clave'");
		
//print_r("SELECT u.idUsuario,u.nomusuario,u.clave,u.vigente,u.__modificoUsuario,u.__modificoFecha,u.clave1 FROM cerrosazules.usuario u WHERE u.nomusuario = '$usuario' AND u.clave = '$clave'");
	//print_r($_resultSet);
	...
	function get_validaUsuario( $usuario,$clave ) {
        ...
        // retrieved value in the database
        $_resultSet = $dbConn->doQuery("SELECT * FROM nomusuario WHERE nomusuario = '$usuario' AND clave = '$clave'");
