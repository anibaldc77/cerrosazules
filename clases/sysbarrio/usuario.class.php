...
$clave1); 
        ...
        $dbConn->insert("systarjetas.usuario", $_obj);
    ...
    function get_usuario( $idUsuario ) {
        ...
        $_resultSet = $dbConn->doQuery("SELECT * FROM systarjetas.usuario WHERE idUsuario = '$idUsuario'");
    ...
    function update_usuario( $idUsuario, $itemsToBeUpdated = array() ) {
         ...
         $dbConn->update("systarjetas.usuario", "idUsuario = '$idUsuario'");
    }
    ...
    function delete_usuario( $idUsuario ) {
         ...
         $dbConn->delete("systarjetas.usuario", "idUsuario = '$idUsuario'");
    }
    ...
    function list_usuario( $conditionalStatement = '' ) {
         ...
         if(!empty($conditionalStatement)) { 
              $sqlStatement = "SELECT * FROM systarjetas.usuario WHERE $conditionalStatement"; 
         } else { 
              $sqlStatement = "SELECT * FROM systarjetas.usuario";
         }
