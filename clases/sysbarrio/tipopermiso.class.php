...
$__modificoFecha); 
        ...
        $dbConn->insert("systarjetas.tipopermiso", $_obj);
    ...
    function get_tipopermiso( $idTipoPermiso ) {
        ...
        $_resultSet = $dbConn->doQuery("SELECT * FROM systarjetas.tipopermiso WHERE idTipoPermiso = '$idTipoPermiso'");
    ...
    function update_tipopermiso( $idTipoPermiso, $itemsToBeUpdated = array() ) {
         ...
         $dbConn->update("systarjetas.tipopermiso", "idTipoPermiso = '$idTipoPermiso'");
    }
    ...
    function delete_tipopermiso( $idTipoPermiso ) {
         ...
         $dbConn->delete("systarjetas.tipopermiso", "idTipoPermiso = '$idTipoPermiso'");
    }
    ...
    function list_tipopermiso( $conditionalStatement = '' ) {
         ...
         if(!empty($conditionalStatement)) { 
              $sqlStatement = "SELECT * FROM systarjetas.tipopermiso WHERE $conditionalStatement"; 
         } else { 
              $sqlStatement = "SELECT * FROM systarjetas.tipopermiso";
         }
