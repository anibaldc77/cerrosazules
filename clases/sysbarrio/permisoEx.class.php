...
class permisoEx extends Permiso { 
	...
	/////Funcion Agregada /////////////////////////////////////////
	  function get_permisoSistema( $idUsuario, $idObjeto, $idTipoPermiso ) {
        ...
        $_resultSet = $dbConn->doQuery("SELECT * FROM cerrosazules.permiso WHERE idUsuario = '$idUsuario' AND idObjeto = '$idObjeto' AND idTipoPermiso = '$idTipoPermiso'");
...
*/		
		$consulta = ($habilitadoUsuario==1)?" and usuario.vigente ='1'":"";
		$consulta .= ($habilitadoObjeto==1)?" and objeto.habilitado ='1'":"";
