...
$habilitado); 
        ...
        $dbConn->insert("systarjetas.itenmenu", $_obj);
    ...
    function get_itenmenu( $idItemMenu ) {
        ...
        $_resultSet = $dbConn->doQuery("SELECT * FROM systarjetas.itenmenu WHERE idItemMenu = '$idItemMenu'");
    ...
    function update_itenmenu( $idItemMenu, $itemsToBeUpdated = array() ) {
         ...
         $dbConn->update("systarjetas.itenmenu", "idItemMenu = '$idItemMenu'");
    }
    ...
    function delete_itenmenu( $idItemMenu ) {
         ...
         $dbConn->delete("systarjetas.itenmenu", "idItemMenu = '$idItemMenu'");
    }
    ...
    function list_itenmenu( $conditionalStatement = '' ) {
         ...
         if(!empty($conditionalStatement)) { 
              $sqlStatement = "SELECT * FROM systarjetas.itenmenu WHERE $conditionalStatement"; 
         } else { 
              $sqlStatement = "SELECT * FROM systarjetas.itenmenu";
         }
