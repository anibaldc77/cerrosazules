...
$_tiempo); 
        ...
        $dbConn->insert("seguridad.pedidousuario", $_obj);
    ...
    function get_pedidousuario( $idpedidousuario ) {
        ...
        $_resultSet = $dbConn->doQuery("SELECT * FROM seguridad.pedidousuario WHERE idpedidousuario = '$idpedidousuario'");
    ...
    function update_pedidousuario( $idpedidousuario, $itemsToBeUpdated = array() ) {
         ...
         $dbConn->update("seguridad.pedidousuario", "idpedidousuario = '$idpedidousuario'");
    }
    ...
    function delete_pedidousuario( $idpedidousuario ) {
         ...
         $dbConn->delete("seguridad.pedidousuario", "idpedidousuario = '$idpedidousuario'");
    }
    ...
    function list_pedidousuario( $conditionalStatement = '' ) {
         ...
         if(!empty($conditionalStatement)) { 
              $sqlStatement = "SELECT * FROM seguridad.pedidousuario WHERE $conditionalStatement"; 
         } else { 
              $sqlStatement = "SELECT * FROM seguridad.pedidousuario";
         }
