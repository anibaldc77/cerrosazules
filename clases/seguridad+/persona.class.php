...
$_fechamodifica); 
        ...
        $dbConn->insert("seguridad.persona", $_obj);
    ...
    function get_persona( $id ) {
        ...
        $_resultSet = $dbConn->doQuery("SELECT * FROM seguridad.persona WHERE id = '$id'");
     ...
     * @result void
     **/
    function update_persona( $id, $itemsToBeUpdated = array() ) {
         ...
         $dbConn->update("seguridad.persona", "id = '$id'");
    }
    ...
    function delete_persona( $id ) {
         ...
         $dbConn->delete("seguridad.persona", "id = '$id'");
    }
    ...
    function list_persona( $conditionalStatement = '' ) {
         ...
         if(!empty($conditionalStatement)) { 
              $sqlStatement = "SELECT * FROM seguridad.persona WHERE $conditionalStatement"; 
         } else { 
              $sqlStatement = "SELECT * FROM seguridad.persona";
         }
