...
$__modificoFecha); 
        ...
        $dbConn->insert("seguridad.objeto", $_obj);
    ...
    function get_objeto( $idObjeto ) {
        ...
        $_resultSet = $dbConn->doQuery("SELECT * FROM seguridad.objeto WHERE idObjeto = '$idObjeto'");
    ...
    function update_objeto( $idObjeto, $itemsToBeUpdated = array() ) {
         ...
         $dbConn->update("seguridad.objeto", "idObjeto = '$idObjeto'");
    }
    ...
    function delete_objeto( $idObjeto ) {
         ...
         $dbConn->delete("seguridad.objeto", "idObjeto = '$idObjeto'");
    }
    ...
    function list_objeto( $conditionalStatement = '' ) {
         ...
         if(!empty($conditionalStatement)) { 
              $sqlStatement = "SELECT * FROM seguridad.objeto WHERE $conditionalStatement"; 
         } else { 
              $sqlStatement = "SELECT * FROM seguridad.objeto";
         }
