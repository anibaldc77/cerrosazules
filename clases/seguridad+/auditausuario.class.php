...
$Accion); 
        ...
        $dbConn->insert("seguridad.auditausuario", $_obj);
    ...
    function get_auditausuario( $AuditaId ) {
        ...
        $_resultSet = $dbConn->doQuery("SELECT * FROM seguridad.auditausuario WHERE AuditaId = '$AuditaId'");
    ...
    function update_auditausuario( $AuditaId, $itemsToBeUpdated = array() ) {
         ...
         $dbConn->update("seguridad.auditausuario", "AuditaId = '$AuditaId'");
    }
    ...
    function delete_auditausuario( $AuditaId ) {
         ...
         $dbConn->delete("seguridad.auditausuario", "AuditaId = '$AuditaId'");
    }
    ...
    function list_auditausuario( $conditionalStatement = '' ) {
         ...
         if(!empty($conditionalStatement)) { 
              $sqlStatement = "SELECT * FROM seguridad.auditausuario WHERE $conditionalStatement"; 
         } else { 
              $sqlStatement = "SELECT * FROM seguridad.auditausuario";
         }
